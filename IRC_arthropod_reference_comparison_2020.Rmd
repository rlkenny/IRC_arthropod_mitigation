...
css_tky_bar_tr <- ggplot(css_tky1, aes(x = year_restoration, y = richness_taxa)) +
  ...
  ggtitle(expression(atop(bold("Taxa richness ~ Year of Restoration"), atop(italic("Comparison of Year 5 mitigation data to reference sites"), "")))) +
  theme(plot.title = element_text(hjust = 0.5, face='bold'), legend.position = "none") +
...
ggsave("css_tky_bar_tr.png", plot = tky_bar_tr, device = "png", width = 7, height = 5, units = c("in"), dpi = 300)
